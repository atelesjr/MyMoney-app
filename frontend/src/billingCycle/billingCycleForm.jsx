...
BillingCycleForm = reduxForm({form: 'billingCycleForm', 
    destroyOnUnmount:false})(BillingCycleForm)

//formValueSelector - método que pega o id do formulário.
const selector = formValueSelector('billingCycleForm')
//pega o estado (valor créditos) controlado pelo redux-form e joga nas props do componente.
